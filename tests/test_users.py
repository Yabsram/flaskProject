...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('usernamethatiswaytoolong', 'test@example.com', 'FlaskIsAwesome')
        self.assertIn(b'Field must be between 2 and 20 characters long.', response2.data)
    ...
    def test_invalid_email_registration(self):
        ...
        response2 = self.register('testUsername', 'newtest@seo', 'FlaskIsAwesome')
